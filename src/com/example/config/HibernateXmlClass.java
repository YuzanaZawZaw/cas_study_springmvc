...
public class HibernateXmlClass {
	...
	public LocalSessionFactoryBean sessionFactory(){
		LocalSessionFactoryBean factory=new LocalSessionFactoryBean();
			...
			factory.setPackagesToScan("com.example.hibernate");
			factory.setMappingResources(
					"com/example/hibernate/Posts.hbm.xml",
					"com/example/hibernate/Products.hbm.xml",
					"com/example/hibernate/Quotes.hbm.xml"
					);
		return factory;		
	}
